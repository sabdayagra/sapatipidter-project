...
export default function ReskrimsusPolda() {
  return (
    <div className="px-4 md:px-8 space-y-6">
      <div className="flex flex-col">
        <div className="flex justify-between items-center">
          <p className="font-bold text-lg">Reskrimsus Polda</p>
        </div>
      ...
      <div>
        <div className="relative  overflow-hidden">
          <Image src={subditINews.main.image} alt={subditINews.main.title} width={1920} height={1080} className="object-cover w-full h-56 md:h-[280px]" />
